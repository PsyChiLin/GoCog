...
for (t in 1:10000){
  ...
  set.seed(t)
  dta_3s_per <- dta_3s
  dta_3s_per$GoStage <- sample(dta_3s_per$GoStage) # Permutation
  # equally sampling
  dta_3s_Open <- filter(dta_3s_per, GoStage == "Open")
  dta_3s_Mid <- filter(dta_3s_per, GoStage == "Mid")
  dta_3s_End <- filter(dta_3s_per, GoStage == "End")
  # # Bootstrapping
  ...
  # bind data
  dta_3s_boot <- rbind(dta_3s_Open,dta_3s_Mid,dta_3s_End)
  # 8 folds
...
saveRDS(meanrst_boot,file = "../GoCogdata/GoStage_BothACC_RF_10000_Ex_Perm.Rdata")
