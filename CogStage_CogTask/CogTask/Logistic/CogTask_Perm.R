...
saveRDS(meanrst_perm,file = "Output/CogTask_bACCbRT_log_All_Perm10000.Rdata")
...
# quantile(meanrst_perm$test[,5],c(.025,.975),na.rm = T) 
# 
# saveRDS(meanrst_perm,file = "Output/CogTask_bACCbRT_log_Dan_Perm10000.Rdata")
# 
# 
# ############### Kyu Permutation ###############
# 
...
# quantile(meanrst_perm$test[,5],c(.025,.975),na.rm = T) 
# 
# saveRDS(meanrst_perm,file = "Output/CogTask_bACCbRT_log_Kyu_Perm10000.Rdata")
