...
dta_4c_rst$pred_CogTask <- as.factor(dta_4c_rst$pred_CogTask)
...
for(i in 1:8){
  ...
  y_train_prob_tree <- predict(rst_svm,Calc_train,probability = T)
  y_train_hat <- predict(rst_svm,Calc_train)
  y_test_prob_tree <- predict(rst_svm,Calc_test ,probability = T)
  ...
  y_train_prob_tree <- predict(rst_svm,Reas_train,probability = T)
  y_train_hat <- predict(rst_svm,Reas_train)
  y_test_prob_tree <- predict(rst_svm,Reas_test,probability = T)
  ...
  y_train_prob_tree <- predict(rst_svm,Spat_train,probability = T)
  y_train_hat <- predict(rst_svm,Spat_train)
  y_test_prob_tree <- predict(rst_svm,Spat_test,probability = T)
  ...
  y_train_prob_tree <- predict(rst_svm,None_train,probability = T)
  y_train_hat <- predict(rst_svm,None_train)
  y_test_prob_tree <- predict(rst_svm,None_test,probability = T)
...
# 5 column : all, Calc, Reas, Spat, None
SVM_CogTask[1,2] <- mean(rst$test[,1])
SVM_CogTask[1,3] <- mean(rst$test[,2])
SVM_CogTask[1,4] <- mean(rst$test[,3])
SVM_CogTask[1,5] <- mean(rst$test[,4])
SVM_CogTask[1,6] <- mean(rst$test[,5])
...
# 5 column : all, Calc, Reas, Spat, None
SVM_CogTask[2,2] <- mean(rst$test[,1])
SVM_CogTask[2,3] <- mean(rst$test[,2])
SVM_CogTask[2,4] <- mean(rst$test[,3])
SVM_CogTask[2,5] <- mean(rst$test[,4])
SVM_CogTask[2,6] <- mean(rst$test[,5])
...
# 5 column : all, Calc, Reas, Spat, None
SVM_CogTask[3,2] <- mean(rst$test[,1])
SVM_CogTask[3,3] <- mean(rst$test[,2])
SVM_CogTask[3,4] <- mean(rst$test[,3])
SVM_CogTask[3,5] <- mean(rst$test[,4])
SVM_CogTask[3,6] <- mean(rst$test[,5])

SVM_CogTask
saveRDS(SVM_CogTask,file = "Output/SVM/CogTask_bACCbRT_svm_Rst.Rdata")
#head(dta_4c_rst)
