...
perm_all <- readRDS("Output/GoStage_bACCbRT_SVM_All_Perm10000.Rdata")
rstce <- readRDS("Output/GoStage_bACCbRT_SVM_Rst.Rdata")
rst <- rstce
...
perm_all2 <- readRDS("Output/CogTask_bACCbRT_SVM_All_Perm10000.Rdata")
rstce2 <- readRDS("Output/CogTask_bACCbRT_SVM_Rst.Rdata")
rst2 <- rstce2
...
tiff(file = "../GoCog_Manuscript/FigureTable/附圖1_MLsvm.tiff",height=6, width=6, units="in", res = 300,compression = "lzw")
