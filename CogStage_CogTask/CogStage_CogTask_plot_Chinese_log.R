...
perm_all <- readRDS("Output/GoStage_bACCbRT_log_All_Perm10000.Rdata")
rstce <- readRDS("Output/GoStage_bACCbRT_log_Rst.Rdata")
rst <- rstce
...
perm_all2 <- readRDS("Output/CogTask_bACCbRT_log_All_Perm10000.Rdata")
rstce2 <- readRDS("Output/CogTask_bACCbRT_log_Rst.Rdata")
rst2 <- rstce2
...
png(file = "../GoCog_Manuscript/FigureTable/圖6_MLlog.png",height=6, width=6, units="in", res = 300)
